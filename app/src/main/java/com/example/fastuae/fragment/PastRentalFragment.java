...
public class PastRentalFragment extends Fragment implements BookingCarAdapter.onClick{
    ...
    private void initView() {
        ...
        bookingCarAdapter = new BookingCarAdapter(context, bookingModelList,PastRentalFragment.this,2);
