...
public class P {
    ...
    public static String BaseUrl = "https://www.pivotmkg.com/fastcarmodule/api/";

    public static String languageFlag = "languageFlag";
    ...
    public static String faq_category_name = "faq_category_name";
