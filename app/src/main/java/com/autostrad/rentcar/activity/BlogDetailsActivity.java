...
public class BlogDetailsActivity extends AppCompatActivity {
    ...
    private BlogDetailsActivity activity = this;
    ...
    private void initView() {
        ...
        hitBlogDetailsData(blogSlug,blogId);
    }


    public void hitBlogDetailsData(String blogSlug,String blogId) {
