...
import com.autostrad.rentcar.databinding.FragmentPaymentRelatedBinding;
...
public class PaymentRelatedFragment extends Fragment {

    private Context context;
    private FragmentPaymentRelatedBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (binding == null) {
            binding = DataBindingUtil.inflate(inflater, R.layout.fragment_payment_related, container, false);
    ...
    private void setData(){
        ...
        if (FAQActivity.paymentJsonList!=null){
            faqModelList.clear();
            for (Json json : FAQActivity.paymentJsonList){
    ...
    public static PaymentRelatedFragment newInstance() {
        PaymentRelatedFragment fragment = new PaymentRelatedFragment();
        return fragment;
    }
