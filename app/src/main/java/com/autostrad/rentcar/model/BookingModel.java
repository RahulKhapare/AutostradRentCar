...
public class BookingModel {
    ...
    public String getDropoff_location_name() {
        return dropoff_location_name;
    }

    public void setDropoff_location_name(String dropoff_location_name) {
        this.dropoff_location_name = dropoff_location_name;
    }
