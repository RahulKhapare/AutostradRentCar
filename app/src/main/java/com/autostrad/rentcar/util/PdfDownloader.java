...
public  class PdfDownloader {
    ...
    public static void checkDirectory(Context context,String fileURL,String title,int flag){
        try{
            ...
            H.showMessage(context,context.getResources().getString(R.string.somethingWrong));
        }
    ...
    public static void openPdf(Context context, String filepath){
        ...
        try{
            ...
            H.showMessage(context,context.getResources().getString(R.string.noPdfAppAvailable));
        }
    }

    public static void startDownload(Context context,String fileURL,String title,String destination,int flag){
        H.showMessage(context,context.getResources().getString(R.string.downloading));
        ...
        BroadcastReceiver onComplete = new BroadcastReceiver() {
            public void onReceive(Context ctxt, Intent intent) {
                H.showMessage(ctxt,context.getResources().getString(R.string.downloadingCompete));
